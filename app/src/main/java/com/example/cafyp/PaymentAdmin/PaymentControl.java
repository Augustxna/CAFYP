...
public class PaymentControl extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkpayment.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Intent intent = new Intent(PaymentControl.this,ViewPayment.class);
                Toast.makeText(PaymentControl.this,"Getting Payment Error", Toast.LENGTH_SHORT).show();
        ...
        updatepaymentbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PaymentControl.this, PaymentUpdate.class);
