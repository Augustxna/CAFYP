...
import com.example.cafyp.adapter.MainAdminPaymentAdapter;
...
public class MainAdminViewPayment extends AppCompatActivity {

    RecyclerView paymentRecycleView;
    MainAdminPaymentAdapter mPaymentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_admin_view_payment);
        ...
        mPaymentAdapter = new MainAdminPaymentAdapter(this, mPaymentList, admininvitationcode);
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), MainAdminPaymentDashboard.class);
                startActivity(intent);
                finish();
            }
        });
