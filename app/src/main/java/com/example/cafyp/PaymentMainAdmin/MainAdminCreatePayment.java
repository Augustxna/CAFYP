...
public class MainAdminCreatePayment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_admin_create_payment);
        ...
        paymentcreatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainAdminCreatePayment.this, "Create successfully", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(getApplicationContext(), MainAdminPaymentDashboard.class));
                finish();
            }
        });
