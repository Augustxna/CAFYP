...
public class MainAdminPaymentUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_admin_payment_update);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull @NotNull DatabaseError error) {
                ...
                Intent intent = new Intent(MainAdminPaymentUpdate.this, MainAdminViewPayment.class);
                startActivity(intent);
                Toast.makeText(MainAdminPaymentUpdate.this, "Getting Payment error", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        paymentupdatebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(MainAdminPaymentUpdate.this);
                ...
                builder.setPositiveButton("Update", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Toast.makeText(MainAdminPaymentUpdate.this, "Updated Successfully", Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), MainAdminPaymentControl.class);
