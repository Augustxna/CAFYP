...
public class ViewRelatedHeirs extends AppCompatActivity {

    RecyclerView relatedheirsRecycleView;
    RelatedHeirsAdapter mRelatedHeirsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_related_heirs);
        ...
        //String relatedmemberid = "+601128692488";
        ...
        mRelatedHeirsAdapter = new RelatedHeirsAdapter(this, mRelatedHeirList);
