...
public class ViewAdminBoard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_admin_board);

        adminRecycleView = findViewById(R.id.viewadmin_recycle);
        searchView = findViewById(R.id.searchadmin_bar);
        ...
        mref = mdatabase.getReference(admininvitationcode).child("Admins");

        mAdminList = new ArrayList<>();
        mAdminAdapter = new AdminAdapter(this, mAdminList, admininvitationcode);
        ...
        searchView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int start, int before, int count) {
                ...
                mAdminAdapter.getfilter().filter(charSequence);
                search = charSequence;
            }
