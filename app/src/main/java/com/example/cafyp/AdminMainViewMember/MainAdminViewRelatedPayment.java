...
import com.example.cafyp.adapter.MainAdminRelatedPaymentAdapter;
...
public class MainAdminViewRelatedPayment extends AppCompatActivity {

    RecyclerView relatedPayemntRecycleView;
    MainAdminRelatedPaymentAdapter mRelatedPaymentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_admin_view_related_payment);
        ...
        mRelatedPaymentAdapter = new MainAdminRelatedPaymentAdapter(this, mRelatedPaymentList,getrelatedmemberid);
